      ...
      >
              ...
              <View style={styles.heroBottomContent}>
                ...
                <TouchableOpacity style={styles.searchPill} activeOpacity={0.9}>
                  ...
                  <View style={styles.searchPillTextWrap}>
                    <Text style={styles.searchPillTitle}>Ryu's Admin</Text>
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.footerContainer}>
            ...
            <Text style={styles.versionText}>RYU TRANSIENT HOUSE V2.4.0</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  heroContainer: { width: '100%', height: 340, backgroundColor: COLORS.surfaceDark, shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.1, shadowRadius: 15, elevation: 8 },
  ...
  heroBottomContent: { flex: 1, justifyContent: 'center', alignItems: 'center', gap: 12 }, greetingContainer: { marginBottom: 12 }, greetingText: { fontSize: 26, fontWeight: '800', color: '#FFFFFF', letterSpacing: -0.5, lineHeight: 34, textAlign: 'center' },

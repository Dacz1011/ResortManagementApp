...
const COLORS = {
  ...
  successBg: '#DCFCE7',
  successText: '#16A34A',
  summaryDarkBg: '#BE375A',
  summaryLightBg: '#FDF0F4',
};
  ...
  return (
    <View style={styles.container}>
          ...
          <View style={styles.mainSheet}>
            ...
            <View style={styles.summaryRow}>
              ...
              <View style={[styles.summaryCard, { backgroundColor: COLORS.summaryLightBg }]}>
                ...
                <CalendarDays size={64} color={COLORS.primary} opacity={0.1} style={styles.bgIcon} />
              </View>
            </View>
              ...
              {GUEST_HISTORY.map((guest) => (
                <TouchableOpacity key={guest.id} activeOpacity={0.7} style={styles.recordCard}>
                  <View style={styles.recordHeader}>
                    ...
                    <View style={styles.statusBadge}><Text style={styles.statusText}>{guest.status}</Text></View>
                  </View>
      ...
      <TouchableOpacity activeOpacity={0.9} style={styles.fab}>
        <View style={styles.fabInner}><ArrowDownToLine size={24} color="#FFFFFF" strokeWidth={2.5} /></View>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  summaryValueUnit: { fontSize: 14, fontWeight: '700', marginLeft: 4, color: COLORS.primary },
  ...
  pastDaysText: { fontSize: 11, fontWeight: '800', color: COLORS.primary },
  recordsList: { gap: 16 },
  ...
  statusBadge: { backgroundColor: COLORS.background, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
  statusText: { fontSize: 9, fontWeight: '800', color: COLORS.textMuted, letterSpacing: 0.5 },
  ...
  amountValue: { fontSize: 18, fontWeight: '800', color: COLORS.primary, letterSpacing: -0.5 },
  fab: { position: 'absolute', bottom: 120, right: 24, width: 64, height: 64, borderRadius: 20, backgroundColor: COLORS.primary, justifyContent: 'center', alignItems: 'center', shadowColor: COLORS.primary, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.35, shadowRadius: 16, elevation: 8, zIndex: 10 },

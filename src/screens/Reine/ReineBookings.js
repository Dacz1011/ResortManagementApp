...
export default function ReineBookings({ route, navigation }) {
  ...
  const bookings = getBookings('Reine');
    ...
    for (let i = 0; i < days; i++) {
      ...
      if (
        ...
        newBookings[currentDay.getDate()] = {
          ...
          status: 'CONFIRMED',
          amount: `₱${(15000 * days).toLocaleString()}.00`,
        };
        newlyBookedDates.push(currentDay.getDate()); // Add to tracking
      }
    }

    addBooking('Reine', newBookings);
    ...
    Alert.alert(
      ...
      [
        { text: 'No', style: 'cancel' },
        {
          ...
          style: 'destructive',
          onPress: async () => {
            await deleteStay('Reine', currentBooking.guestName, currentBooking.checkIn, currentBooking.checkOut);
              ...
              <View style={styles.detailsCardBody}>
                ...
                <View style={styles.cardFooter}>
                  ...
                  <View style={styles.actionRow}>
                    ...
                    <TouchableOpacity style={styles.primaryButton} activeOpacity={0.8} onPress={handleDialGuest}>
                      <MessageSquare size={18} color="#FFFFFF" strokeWidth={2.5} style={{ marginRight: 8 }} />
                      <Text style={styles.primaryButtonText}>Message Guest</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              </View>
            ...
            <TouchableOpacity style={styles.snapshotCard} activeOpacity={0.8}>
              ...
              >
                ...
                <View style={styles.snapshotContent}>
                  ...
                  <View>
                    <Text style={styles.snapshotValue}>₱{(15000 * upcomingCount).toLocaleString()}</Text>
        ...
        >
          ...
          <View style={styles.mainContent}>
            ...
            <View style={styles.financialCard}>
              ...
              <View style={styles.financialValueRow}>
                <Text style={styles.financialCurrency}>
                  ₱{(15000 * parseInt(numDays || 1)).toLocaleString()}
                </Text>
                <Text style={styles.financialNight}>.00 / {numDays} night(s)</Text>
              </View>
            </View>

            {/* Submit — full-width primary pink pill */}
            <TouchableOpacity
            ...
            >
              ...
              <Text style={styles.primarySubmitBtnText}>Confirm Booking</Text>
            </TouchableOpacity>

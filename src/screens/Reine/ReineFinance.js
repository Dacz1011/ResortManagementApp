...
export default function ReineFinance({ navigation }) {
  ...
  const fetchFinanceData = async () => {
    try {
      ...
      const propertyName = "Reine Beach House";
        ...
        >
          ...
          <View style={[styles.safeArea, { paddingTop: Platform.OS === 'ios' ? insets.top + 10 : StatusBar.currentHeight + 8 }]}>
            ...
            <View style={styles.heroBottomContent}>
              ...
              {/* Dark pill with trend — mirrors ReineHome search pill */}
          ...
          <TouchableOpacity style={styles.snapshotCard} activeOpacity={0.8}>
            ...
            >
              ...
              <View style={styles.snapshotContent}>
                ...
                <View>
                  <Text style={styles.snapshotValue}>₱{stats.income.toLocaleString()}</Text>
          ...
          <TouchableOpacity style={styles.snapshotCard} activeOpacity={0.8}>
            ...
            >
              ...
              <View style={styles.snapshotContent}>
                ...
                <View>
                  <Text style={styles.snapshotValue}>₱{stats.expenses.toLocaleString()}</Text>
          ...
          <TouchableOpacity style={styles.snapshotCard} activeOpacity={0.8}>
            ...
            >
              ...
              <View style={styles.snapshotContent}>
                ...
                <View>
                  <Text style={styles.snapshotValue}>₱{stats.net.toLocaleString()}</Text>
    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={[styles.heroContainer, { height: 220 }]}>
          ...
          >
            <View style={styles.heroOverlay} />
            {/* iOS Fix: Dynamic view block for the form hero top padding */}
            <View style={[styles.safeArea, { paddingTop: Platform.OS === 'ios' ? insets.top + 10 : StatusBar.currentHeight + 8 }]}>
              <View style={styles.topBar}>
                <TouchableOpacity
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.formCard}>
            ...
            <TouchableOpacity style={styles.pinkSubmitBtn} activeOpacity={0.85} onPress={handleLogUtility}>

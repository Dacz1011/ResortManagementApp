...
export default function ReineHome({ navigation }) {
  ...
  useEffect(() => {
    ...
    const loadTasks = async () => {
      const storedTasks = await mockDb.getAll('reine_tasks');
      if (storedTasks && storedTasks.length > 0) {
        ...
        await mockDb.saveAll('reine_tasks', defaultTasks);
      }
    };
    loadTasks();
  }, []);
      ...
      >
        <View style={styles.heroContainer}>
          ...
          >
            ...
            <View style={[styles.topBar, { top: Platform.OS === 'ios' ? insets.top + 10 : StatusBar.currentHeight + 10 }]}>
            ...
            <View style={styles.cardBody}>
              ...
              <View style={styles.cardFooter}>
                ...
                <TouchableOpacity style={styles.primaryButton} activeOpacity={0.8}>
                  <Text style={styles.primaryButtonText}>Mark Cleaned</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
              ...
              >
                ...
                <View style={styles.snapshotContent}>
                  ...
                  <View>
                    ...
                    <Text style={styles.snapshotLabel}>Weather Status</Text>
                  </View>
                </View>
              </ImageBackground>
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  heroSafeArea: { flex: 1, paddingHorizontal: 24, justifyContent: 'center', alignItems: 'center' },
  topBar: { position: 'absolute', left: 24, right: 24, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', zIndex: 10 },
  ...
  heroBottomContent: { width: '100%', alignItems: 'center', marginTop: 80 },
  greetingSub: { fontSize: 13, fontWeight: '800', color: '#FFFFFF', letterSpacing: 2, marginBottom: 10, opacity: 0.9, textAlign: 'center' },
  greetingText: { fontSize: 40, fontWeight: '800', color: '#FFFFFF', letterSpacing: -1.2, lineHeight: 46, marginBottom: 32, textAlign: 'center' },
  ...
  actionPillDark: { backgroundColor: COLORS.primary, paddingHorizontal: 20, height: 44, justifyContent: 'center', alignItems: 'center', borderRadius: 100 },
  actionPillDarkText: { color: '#FFFFFF', fontSize: 14, fontWeight: '700' },
  actionPillLight: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.primaryLight, paddingHorizontal: 16, height: 44, justifyContent: 'center', borderRadius: 100, borderWidth: 1, borderColor: 'rgba(230, 78, 118, 0.1)' },
  actionPillLightText: { color: COLORS.primary, fontSize: 14, fontWeight: '600' },
  ...
  primaryButton: { backgroundColor: COLORS.primary, paddingHorizontal: 24, paddingVertical: 12, borderRadius: 100 },
  ...
  actionTextResolve: { fontSize: 13, fontWeight: '800', marginRight: 4 },

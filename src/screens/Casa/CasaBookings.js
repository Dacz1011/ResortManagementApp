    ...
    for (let i = 0; i < days; i++) {
      ...
      if (currentDay.getMonth() === currentMonth.getMonth() &&
        ...
        newBookings[currentDay.getDate()] = {
          ...
          status: 'CONFIRMED',
          amount: `₱${(15000 * days).toLocaleString()}.00`, // Casa rate: 15,000
  ...
  const renderCalendarView = () => {
    ...
    return (
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent} bounces={false}>
        {/* HERO IMAGE HEADER (Unified Design Pattern) */}
        <ImageBackground
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent} bounces={false}>
          ...
          <View style={styles.mainSheet}>
            ...
            {/* Total Amount Due styled in Casa Primary */}
            <View style={styles.financialCard}>
              ...
              <View style={styles.financialValueRow}>
                <Text style={styles.financialCurrency}>₱{(15000 * parseInt(numDays || 1)).toLocaleString()}</Text>

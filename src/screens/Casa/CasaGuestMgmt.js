    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroContainer}>
          <ImageBackground
            source={{ uri: 'https://images.unsplash.com/photo-1510798831971-661eb04b3739?q=80&w=2070&auto=format&fit=crop' }}
          ...
          >
            ...
            <View style={[styles.safeArea, { paddingTop: Platform.OS === 'ios' ? insets.top + 10 : StatusBar.currentHeight + 8 }]}>
              <View style={styles.topBar}>
                ...
                <TouchableOpacity style={styles.iconBtnDark} activeOpacity={0.8} onPress={() => navigation.navigate('CasaBookings', { mode: 'manual' })}>
              ...
              <View style={styles.heroBottomContent}>
                ...
                <Text style={styles.heroSubStat}>Active roster for Casa M.O.</Text>

                <TouchableOpacity style={styles.searchPill} activeOpacity={0.9} onPress={() => navigation.navigate('CasaGuestHistory')}>
        ...
        <View style={styles.quickActionsWrapper}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.quickActionsScroll}>
            ...
            <TouchableOpacity style={styles.actionPillLight} activeOpacity={0.7} onPress={() => navigation.navigate('CasaGuestHistory')}>
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.guestList}>
            {/* New Entry Card */}
            <TouchableOpacity activeOpacity={0.8} style={styles.newEntryCard} onPress={() => navigation.navigate('CasaBookings', { mode: 'manual' })}>
            ...
            {guests.length > 0 ? (
              ...
              <View style={styles.emptyCard}>
                ...
                <TouchableOpacity style={styles.blackButton} activeOpacity={0.85} onPress={() => navigation.navigate('CasaBookings', { mode: 'manual' })}>
